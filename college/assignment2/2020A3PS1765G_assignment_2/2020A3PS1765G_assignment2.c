...
int main() {
    ...
    if (first_fork == -1) {
        ...
        // Print result from child along with the Role(Parent) and pid
        ...
        if (second_fork == -1) {
            ...
            // Print input from parent along with Role (Child) with pid
            ...
            // Print number from GrandChild along with the Role (Child) and pid
            ...
            // Print input from child along with (Role) GrandChild and pid
